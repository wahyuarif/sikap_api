...
if(!$_SESSION){
    ...
    if($kode_petugas==''){
        ...
        WHERE tgl_donasi BETWEEN '$dari_prog_tgl' AND '$sampai_prog_tgl' AND kode_program='$program'
        ...
        WHERE tgl_donasi BETWEEN '$dari_prog_tgl' AND '$sampai_prog_tgl' AND kode_program='$program' AND createdby='$kode_petugas'
